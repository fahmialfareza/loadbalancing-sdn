...
class ShareIt(app_manager.RyuApp):
	...
	def __init__(self, *args, **kwargs):
        	...
        	self.mac_to_port = {}
		self.servers = []
		self.servers.append({'ip':"192.168.7.1", 'mac':"00:19:21:68:00:01"})
		self.servers.append({'ip':"192.168.7.2", 'mac':"00:19:21:68:00:02"})
		self.servers.append({'ip':"192.168.7.3", 'mac':"00:19:21:68:00:03"})
