...
class loadbalancer(app_manager.RyuApp):
    ...
    def _packet_in_handler(self, ev):
        ...
        if tcp_header.dst_port == 80:
            ...
            flow_mod = parser.OFPFlowMod(datapath=datapath, match=match, idle_timeout=5, instructions=inst,
            ...
            flow_mod2 = parser.OFPFlowMod(
                datapath=datapath, match=match, idle_timeout=5, instructions=inst2, cookie=cookie)
